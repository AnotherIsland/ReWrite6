...
<html>
    <head>
        ...
        <script>
          // Initialize Firebase
          var config = {
            apiKey: "AIzaSyBz6Zf7C7vd_3WPm8Ib-_L8QW7cP3X3sm4",
            authDomain: "rewrite-6f639.firebaseapp.com",
            databaseURL: "https://rewrite-6f639.firebaseio.com",
            projectId: "rewrite-6f639",
            storageBucket: "rewrite-6f639.appspot.com",
            messagingSenderId: "818233646389"
          };
            ...
            <div class="row white z-depth-4 section col s12 l12 m12 xl12">
                ...
                <div class="row">
                    ...
                    <div class="col s5 l5 m5 xl5 ">
                        <div class="">
                            <h3>Registro</h3>
                            <form action="" method=""  id="formR" name="formR">
                                <div class="row">
